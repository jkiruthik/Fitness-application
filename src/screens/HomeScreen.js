...
export default function HomeScreen() {
  ...
  const latestWorkout = workoutLogs.find(
    (item) =>
      item.userId === currentUserId && item.status === "completed"
  );
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.workout}>
          {latestWorkout.workoutType} Workout
        </Text>
        <Text style={styles.bodyText}>
          Duration: {latestWorkout.durationMinutes} min
        </Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.bodyText}>
          {subscription.status === "active"
            ? subscription.priceTier
            : "Cancelled"}{" "}
          · {subscription.renewalCadence}
        </Text>
      </View>
